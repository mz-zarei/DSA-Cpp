...
void informalTests() {
...

  {
    ...
    std::cout << "List: " << l << std::endl;
    l.insertOrdered(7);
    std::cout << "List after adding 7: " << l << std::endl;
    l.insertOrdered(4);
    std::cout << "List after adding 4: " << l << std::endl;
    l.insertOrdered(-1);
    std::cout << "List after adding -1: " << l << std::endl;
    l.insertOrdered(10);
    std::cout << "List after adding 10: " << l << std::endl;
